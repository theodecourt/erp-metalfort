...
from app.routers import admin_combos, admin_composicoes, combos, compra, estoque, fornecedor, material, produto, public_quote, quote
...
app.include_router(admin_composicoes.router)
